...
get_fourier_image = lambda X, V, func: np.array([1 / (np.sqrt(2 * np.pi)) * dotProduct(X, func, (lambda t: np.e ** (-1j * image_clip * t))(X)) for image_clip in V])
...
# filtering(a=5, b=1, c=0, d=0, t1=2, t2=4, filter=get_order_filter(T=0.5))
# filtering(a=5, b=1, c=0, d=0, t1=2, t2=4, filter=get_order_filter(T=0.25))
# filtering(a=20, b=1, c=0, d=0, t1=2, t2=4, filter=get_order_filter(T=0.25))
